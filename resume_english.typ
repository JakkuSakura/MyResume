...
#show: resume.with(
  ...
  contacts: (
    "WA/Tel: 91408309",
    [#link("mailto:qjk2001@gmail.com")[Email]],
...
#skills((
  ...
  ("HFT", (
    [Solo "full stack" High Frequency Trading systems builder about market-making and arbitraging],
  )),
  ("Algorithm", (
    [Algorithm and Data Structure training and competitions in middle and high school],
  )),
  ("Others", (
    [A wide technical stack, all main stream languages in fields from backend to basic frontend, from machine learning to smart contracts],
  ))
))
...
#exp(
  ...
  details: [
    ...
    - Designed and developed simulators for various exchanges, enabling accurate testing and evaluation of software and hardware order management system in simulated real-time environments
    - Optimized the machine learning framework to achieve 3x predict speed improvement
  ],
)

#exp(
  role: "Consultant",
  project: "High Frequency Trading of Cryptocurrencies", 
  date: "Jul 2020 - Feb 2023",
  details: [
    - Designed and developed trading systems in Rust from scratch, modular design, with focus on ultimate low latency. tick2order latency 10us
    - Implemented market-making and arbitraging algorithms that earn profits in production, supporting 5 researchers and traders. APR 50%
    - Built highly efficient links about a range of centralized and decentralized exchanges
    - Worked on a TCP stack in Rust, running on DPDK to work around limitation of linux kernal network stack
    - Invented various tools like json parser and http request formatter, outperforming the defacto library by a margin
...
#exp(
  ...
  details: [
    ...
    - Maintained and improved on DevFlow, a platform that integrates a fluent online editor, peer review for API changes, linting, compatibility check, code generation
    - Maintained and improved on Overpass, a widely used platform that collects RPC definition files and generate RPC client for other go projects
  ],
)
...
#exp(
  ...
  details: [
    ...
    - Bridges high-level abstractions with low-level code generation.
  ]
)


= Awards and Certifications
- China Computer Federation Certified Student Member #h(1fr) Jul 2019-Now

- First Prize in High School Group of National Informatics Olympiad in Provinces #h(1fr) Nov 2017, Nov 2018
...
- First Prize(1st) in national finals of 19th He Education Cup Computer Competition #h(1fr) Jul 2016
// - 3rd in the Weifang Experimental and Practical Competition #h(1fr) Jul 2015
// - Qualification Certify for National Youth Robotics Level Test, Second Class #h(1fr) Oct 2018
// - National Computer Rank Examination Level 3, Network Technology #h(1fr) May 2016
// - National Computer Rank Examination Level 2, C language // Nov 2015
