...
\name{Jiangkun QIU}
\address{
    \faPhone~+852 91408309(WhatsApp)
    \faEnvelope~\href{mailto://qjk2001@gmail.com}{qjk2001@gmail.com} \faGithub~\href{https://github.com/qiujiangkun/}{qiujiangkun} \faWeixin~JakkuSakura ~~~~~~~
}
...
\begin{rSection}{\faUsers~Working Experienes}
    \begin{rExperience}{Market Access}{Qube Research and Technologies}{Feb 2023-Aug 2022}
        \begin{itemize}
            ...
            \item Studied mathematical techniques for backtesting
        \end{itemize}
    \end{rExperience}
