...
\begin{rSection}{\faUsers~Working Experienes}
    \begin{rExperience}{Internship Server Arch}{Beijing ByteDance Technology Co., Ltd.}{Apr 2022-Sep 2022}
        ...
        \end{itemize}
    \end{rExperience}
    \begin{rExperience}{Full-time Backend Dev}{ERX Inc, Thailand}{Mar 2022-Now}
        \textbf{Context}:
    ...
    \begin{rExperience}{Backend Internship}{Shanghai Rangchuan Information Technology Co., Ltd.}{Dec 2020-June 2021}
        ...
        \end{itemize}
    \end{rExperience}
    \begin{rExperience}{Part-time Job}{High Frequency Trading of Cryptocurrencies, Personal Project}{Jul 2020-Feb 2022}
        \begin{itemize}
            \itemsep -0.5em \vspace{-0.5em}
...
\begin{rSection}{\faUsers~Projects}
    ...
    \end{rProject}
    \begin{rProject}{Personal Project}{Unidef}{Jul 2021-Now}
