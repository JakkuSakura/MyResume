...
#exp(
  ...
  date: "2025年1月 - 至今",
  summary: "全球领先的流动性提供商和高频交易公司",
  details: [
    - 设计并实现高性能交易所连接框架，缩短新交易场所集成时间，同时确保监管合规性
    - 统筹规划并执行DevOps基础设施的全面现代化，引入容器化、CI/CD管道和基础设施即代码实践，减少部署失败
    - 通过高级性能分析和算法优化，提升性能关键路径，实现订单执行延迟降低30%，同时增强容错能力
  ]
)
